...
CREATE TABLE IF NOT EXISTS tb_pembelian (
    ...
    jenis_pembelian character varying(20) NOT NULL,
    jenis_operasional character varying(50),
    kategori_operasional character varying(20),
    id_supplier bigint,
    grand_total numeric(18, 2),
    jenis_pembayaran character varying(20),
...
CREATE TABLE IF NOT EXISTS tb_penjualan (
    ...
    no_penjualan character varying(25) NOT NULL,
    grand_total integer,
    diskon numeric(18, 2),
    ppn numeric(18, 2),
...
CREATE TABLE IF NOT EXISTS tb_spk (
    ...
    status_spk character varying(20),
...
CREATE TABLE IF NOT EXISTS tb_supplier (
    ...
    no_hp_kontak character varying(20),
    no_telepon character varying(20),
